...
<div class="container demo-1">
  <div class="content">
    <div id="large-header" class="large-header">
      ...
      <div class="logo_box">
        <h3>销售后台登陆</h3>
        <form class="layui-form zyl_pad_01" action="{{url('store')}}" method="post">
          <div class="layui-col-sm12 layui-col-md12">
            <div class="layui-form-item">
              <input type="text" name="uname" l autocomplete="off" placeholder="账号" class="layui-input">
              <i class="layui-icon layui-icon-username zyl_lofo_icon"></i>
            </div>
          </div>
          <div class="layui-col-sm12 layui-col-md12">
            <div class="layui-form-item">
              <input type="password" name="upwd"  autocomplete="off" placeholder="密码" class="layui-input">
              <i class="layui-icon layui-icon-password zyl_lofo_icon"></i>
            </div>
          </div>
          <div class="layui-col-sm12 layui-col-md12">
            <input class="layui-btn layui-btn-fluid" type="submit" value="立即登录"><br><hr>
            <a href="{{url('reg')}}" class="layui-btn layui-btn-fluid" lay-submit="" lay-filter="demo1">注册</a>
          </div>
        </form>
      </div>
    </div>
